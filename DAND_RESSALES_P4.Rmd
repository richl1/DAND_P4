...
library(readr)
rs <- read_csv("C:/Users/rl1891/version-control/R/Project4/rs.txt", 
...
```{r houses for Sale, message=FALSE, warning=FALSE}
ggplot(aes(x=houses_forsale), data = rsl) +
  geom_histogram(binwidth = 5) +
  geom_vline(aes(xintercept=mean(houses_forsale, na.rm=T)),
               color="red", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(subset(rsl, 
              !is.na(houses_forsale))$houses_forsale, 0.25)),
             color = 'blue') +
  geom_vline(aes(xintercept=quantile(subset(rsl, 
              !is.na(houses_forsale))$houses_forsale, 0.75)),
             color = 'blue') +
  xlab("Houses For Sale") +
  ggtitle("Histogram: Houses For Sale (1963 - 2016)")

```

```{r}
summary(rsl$houses_forsale)
```

__The above table summarizes the distribution of the Houses For Sale__
There is a significant variance of Houses For Sale over time
...
ggplot(aes(x=median_price_sold/1000), data = rsl) +
  geom_histogram(binwidth = 5 ) +
  geom_vline(aes(xintercept=mean(median_price_sold/1000, na.rm=T)),
               color="red", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(subset(rsl, 
              !is.na(median_price_sold))$median_price_sold/1000, 0.25)),
             color = 'blue') +
  geom_vline(aes(xintercept=quantile(subset(rsl, 
              !is.na(median_price_sold))$median_price_sold/1000, 0.75)),
             color = 'blue') +
  xlab("Median Price Sold x 1,000 USD") +
  ggtitle("Histogram: Median Price Sold (1963 - 2016)")
...
```{r}
summary(rsl$median_price_sold)
```

__The above table summarizes the distribution of the Median Price Sold__
The skewed distribution is likely due to variations in price over time. 
...
ggplot(aes(x=median_months_forsale), 
  ...
  geom_vline(aes(xintercept=mean(median_months_forsale, na.rm=T)),
               color="red", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(subset(rsl, 
              !is.na(median_months_forsale))$median_months_forsale, 0.25)),
               color="blue", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(subset(rsl, 
              !is.na(median_months_forsale))$median_months_forsale, 0.75)),
               color="blue", linetype="dashed", size=1) +
  xlim(2,quantile(subset(rsl, 
              !is.na(median_months_forsale))$median_months_forsale, 0.95)) +
  ggtitle('HISTOGRAM: Medium Months for Sale (1963-2016)')
```

```{r}
summary(rsl$median_months_forsale)
```

__The above tables summarizes the distribution for Meadian Months For Sale__
Houses typically remain "For Sale" from 4 to 6 months.
...
ggplot(aes(x=months_supply), 
  ...
  geom_vline(aes(xintercept=mean(months_supply, na.rm=T)),
               color="red", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(subset(rsl, 
              !is.na(months_supply))$months_supply, 0.25)),
               color="blue", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(subset(rsl, 
              !is.na(months_supply))$months_supply, 0.75)),
               color="blue", linetype="dashed", size=1) +
...
```{r}
summary(rsl$months_supply)
```

***

__The above tables summarizes the distribution for Months Supply at current rate__
Usually, there is between 4.9 and 7 months supply of houses
...
ggplot(aes(x=annual_rate_sold), data =rsl) +
  ...
  geom_vline(aes(xintercept=mean(annual_rate_sold, na.rm=T)),
               color="red", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(subset(rsl, 
              !is.na(annual_rate_sold))$annual_rate_sold, 0.25)),
               color="blue", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(subset(rsl, 
              !is.na(annual_rate_sold))$annual_rate_sold, 0.75)),
               color="blue", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(subset(rsl, 
              !is.na(annual_rate_sold))$annual_rate_sold, 0.5)),
               color="black", linetype="dashed", size=1) +
  xlim(0,quantile(subset(rsl, 
              !is.na(annual_rate_sold))$annual_rate_sold, 0.95)) +
  ggtitle('HISTOGRAM: Annual Sales Rate  (1963-2016)')
```

```{r}
summary(rsl$annual_rate_sold)
```

__The above tables summarizes the distribution for Annual Sales Rate__
There is a large variance in the annual rate sold
...
ggplot(aes(x= completed_houses_forsale/completed_houses_sold), 
  ...
  xlim(0,10) +
  geom_vline(aes(xintercept=mean(completed_houses_forsale/completed_houses_sold, 
                na.rm=T)), color="red", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(completed_houses_forsale/completed_houses_sold, 
                na.rm=T, probs=.25)), color="blue", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(completed_houses_forsale/completed_houses_sold, 
                na.rm=T, probs=.75)), color="blue", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(completed_houses_forsale/completed_houses_sold, 
                na.rm=T, probs=.5)),  color="blue", linetype="dashed", size=1) +
  ggtitle('HISTOGRAM: COMPLETED HOUSES (FOR SALE/SOLD)  (1963-2016)')
```


```{r}
summary(rsl$completed_houses_forsale/rsl$completed_houses_sold)
```

__The above tables summarizes the distribution for Completed Houses (For Sale / Sold)__
This ratio typically varies between 4x and 6x.
...
```{r}
summary(rsl$not_started_forsale/rsl$not_started_sold)
```
__The above tables summarizes the distribution for Not Started Houses (For Sale / Sold)__
This ration shows a large variance over the past 50+ years.
...
ratio = rsl$under_construction_forsale / rsl$under_construction_sold
ggplot(aes(x= ratio), 
       data = rsl) +
  geom_histogram(binwidth = .1) +
  xlim(3,15) +
  geom_vline(aes(xintercept=mean(ratio, na.rm=T)), 
             color="red", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(ratio, na.rm=T, probs=.25)), 
             color="blue", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(ratio, na.rm=T, probs=.75)), 
             color="blue", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(ratio, na.rm=T, probs=.5)), 
             color="blue", linetype="dashed", size=1) +
...
```{r}
summary(rsl$under_construction_forsale/rsl$under_construction_sold)
```

__The above tables summarizes the distribution for Not Started (For Sale / Sold)__
This ratio typically varies between 7x and 10x.
...
The following plots use ggpairs to look at (16) variables against each other.

To simplify the plots, they are shown in four groups of four.


```{r ggpairs ForSale, message=FALSE, warning=FALSE}

ggpairs(rsl, columns = c("houses_forsale", "completed_houses_forsale", 
                         "under_construction_forsale", "not_started_forsale"), 
        columnLabels = c("Total", "Completed", "UnderConstruct", 
                         "Not Started")) + 
  ggtitle("FOR SALE: Total/Completed/UnderConstruction/NotStarted")
```


```{r ggpairs Sold, message=FALSE, warning=FALSE}

ggpairs(rsl, columns = c("house_sold", "completed_houses_sold", 
                         "under_construction_sold", "not_started_sold"), 
        columnLabels = c("Total", "Completed", "UnderConstruct", 
                         "Not Started")) +
  ggtitle("SOLD: Total/Completed/UnserConstruction/NotStarted")

```


```{r, message=FALSE, warning=FALSE}
ggpairs(rsl, columns = c("geoID", "houses_forsale", "house_sold", 
                         "annual_rate_sold"), 
        columnLabels = c("GEO ID", "FOR SALE", "SOLD", 
                         "Annual Rate")) +
  ggtitle("By GeoID, For Sale, Sold, Annual Rate")
```

```{r, message=FALSE, warning=FALSE}
ggpairs(rsl, columns = c("mean_price_sold", "median_price_sold", 
                         "median_months_forsale", "months_supply"), 
        columnLabels = c("Mean Price", "Median Price", "Months Forsale", 
                         "Months Supply")) +
  ggtitle("Mean/Median Price / Months For Sale / Months Supply")
```
...
ggplot(aes(x= houses_forsale/house_sold), 
  ...
  geom_vline(aes(xintercept=mean(houses_forsale/house_sold, na.rm=T)),
               color="black", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(houses_forsale/house_sold, 
                na.rm=T, probs=.25)),
               color="blue", linetype="dashed", size=1) +
  geom_vline(aes(xintercept=quantile(houses_forsale/house_sold, 
                na.rm=T, probs=.75)),
...
```{r}
summary(rsl$houses_forsale/rsl$house_sold)
```

__The above tables summarizes the distribution for Houses For Sale / Houses Sold__
...
The next plot is a Median Price Sold by Date.
...
```{r, message=FALSE, warning=FALSE}
# geom_line does not work due to parital geoIDs over the time period
ggplot(aes(x=date, y=median_price_sold/1000), 
  ...
  ylab("Median Price Sold x 1,000 (USD)")
```
...
# geom_line() does not work due to partially categorized data
ggplot(aes(x=date, y=months_supply), data = rsl) +
  ...
  scale_x_date(date_breaks = "5 year", date_labels = "%Y") +
  ylab("Months of Supply at Current Rate")
```
...
library(scales)
ratio = rsl$completed_houses_forsale / rsl$completed_houses_sold
ggplot(aes(x=date, y=ratio), 
  ...
  scale_x_date(date_breaks = "5 year",
               labels=date_format("%Y"),
               limits = as.Date(c('1973-01-01','2016-12-31'))) +
  ylab("Completed Houses (For Sale/Sold) x 1,000")
```
...
ratio = rsl$under_construction_forsale/rsl$under_construction_sold
ggplot(aes(x=date, y=(ratio)), 
            data = rsl) + geom_point(alpha = .5, color = 'orange') +
  geom_hline(aes(yintercept=mean(ratio, 
                na.rm=T)), color="red", linetype="dashed", size=1) +
  geom_smooth() +
  ...
  scale_x_date(date_breaks = "5 year",
               labels=date_format("%Y"),
               limits = as.Date(c('1973-01-01','2016-12-31'))) +
  ylab("Under Construction Houses (For Sale/Sold) x 1,000")
...
p_critcal = list(geom_vline(xintercept = 
                 ...
                 geom_vline(xintercept = 
                            ...
                            color = 'green'))
# geom_line does not work due to high frequency noise  
plt <- ggplot(rsl, aes(date, derivative)) + 
          geom_point(alpha = 1/2) +
          scale_x_date(date_breaks = "5 year",
               labels=date_format("%Y"),
               limits = as.Date(c('1973-01-01','2016-12-31'))) +
          ggtitle('1st deriative of Houses Sold by date (d/dt Houses Sold)') +
          ylab("d/dt Houses Sold x 1,000") + ylim(100,450)
...
plt <- ggplot(aes(x=date, y=median_price_sold/1000), data = rsl) +
        geom_point(alpha = .5, color = 'orange') +
        geom_smooth() + 
        scale_x_date(date_breaks = "5 year",
               labels=date_format("%Y"),
...
plt <- ggplot(aes(x=date, y=annual_rate_sold), data = rsl) +
        ...
        ylab("Annual Rate Sold x 1,000 (USD)")
        scale_x_date(date_breaks = "5 year",
               labels=date_format("%Y"),
               limits = as.Date(c('1973-01-01','2016-12-31')))
plt + p_critcal
...
plt <- ggplot(aes(x=date, y=(houses_forsale/house_sold)), 
              data = subset(rsl, rsl$geoID != 'US')) +
        geom_line(aes(color=geoID)) +
        ...
        scale_x_date(date_breaks = "5 year",
               labels=date_format("%Y"),
               limits = as.Date(c('1973-01-01','2016-12-31'))) +
        ylab("Houses (For Sale / Sold) x 1,000 (USD)")
plt + p_critcal
...
rsl2 <- melt(rsl_us[,c("date","houses_forsale", "house_sold")], 
              id.vars = "date")

plt <- ggplot(rsl2, aes(date, value, color = variable)) + 
        geom_line() + geom_smooth() +
        geom_hline(aes(yintercept=mean(rsl_us$houses_forsale, na.rm=T)), 
              color="black", linetype="dashed", size=1) +
        geom_hline(aes(yintercept=mean(rsl_us$house_sold, na.rm=T)), 
              color="black", linetype="dashed", size=1) +
        ylab("Houses For Sale x 1,000") +
        labs(color="Legend:") +
...
### Plot One
```{r echo=FALSE, message=FALSE, warning=FALSE}
plt <- ggplot(aes(x=date, y=houses_forsale), data=rsl_us) +
        geom_line(color = 'orange') +
        geom_hline(aes(yintercept=mean(rsl_us$houses_forsale, na.rm=T)),
               color="red", linetype="dashed", size=1) +
        geom_smooth() +
...
rsl$derivative = c(diff(rsl$houses_forsale) / diff(rsl$per_idx), NA)
plt <- ggplot(rsl, aes(date, derivative)) + 
        geom_point(alpha = 1/2) + ylim(100,450) +
        scale_x_date(date_breaks = "5 year",
               labels=date_format("%Y"),
...
A challenge and learning experience was shaping the dataset for import.  I learned how to use dplyr and related functions.  I am confident that I can "wrangle" any dataset for exploratory data analysis.

Future progress would be to link iother census data to show correlations and perhaps build a pricing model.
